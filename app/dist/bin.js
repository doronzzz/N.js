...
var underscore, utils, constants, widgetFactory, jquery, backbone, loginModel, priceListModel, text, text_loginHTML, loginViewCtrl, text_priceListHTML, text__components_price_list_price_listcss, priceListViewCtrl, Nurego;
(function () {
  // Baseline setup
  // --------------
...
priceListViewCtrl = function (bb, tmpl, utils, css) {
  ...
  return priceList;
}(backbone, text_priceListHTML, utils, text__components_price_list_price_listcss);
Nurego = function (constants, utils, widgetFactory, loginModel, priceListModel, loginViewCtrl, priceListViewCtrl) {
  ...
  return app;
}(constants, utils, widgetFactory, loginModel, priceListModel, loginViewCtrl, priceListViewCtrl);
